...
const plans = {
  free: {
    ...
    features: [
      ...
      'Simulator Sandbox — 3 sessions/day',
      'AI Tutor — 5 messages/day',
      'AI Code Reviewer — 3 reviews/day',
      'Board reference: Arduino Uno + Nano',
  ...
  pro: {
    ...
    features: [
      ...
      'Simulator Sandbox — unlimited sessions',
      'Save up to 10 simulator designs',
      'AI Tutor — 50 messages/day',
      'AI Code Reviewer — unlimited',
      'Full board reference — Mega, ESP32, Pico + interactive pinouts',
      'Step checkpoints + troubleshooting guides',
      'Streak tools + weekly leaderboard',
  ...
  max: {
    ...
    features: [
      ...
      'Free-form Simulator Sandbox — unlimited',
      'The Workshop — curated build projects',
      'Pro-grade boards (Portenta H7, GIGA, Teensy)',
      'Public verifiable profile at /u/your-slug',
      'Free unlimited certificates',
      'Early access to new lessons (7-day head start)',
      'Max-only badges + Discord role',
    ],
  },
}
