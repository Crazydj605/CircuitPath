...
const COMPONENTS: Component[] = [
  ...
  },
  {
    ...
    amazon_search: 'https://www.amazon.com/s?k=2N2222+NPN+transistor+arduino',
  },
  {
    id: 'diode-1n4007',
    ...
    amazon_search: 'https://www.amazon.com/s?k=1N4007+diode+kit+arduino',
  },
  {
    id: 'dc-motor-l298n',
    ...
    amazon_search: 'https://www.amazon.com/s?k=L298N+motor+driver+module+arduino',
  },
  {
    id: 'oled-ssd1306',
    ...
    amazon_search: 'https://www.amazon.com/s?k=SSD1306+OLED+128x64+I2C+arduino',
  },
  {
    id: 'bluetooth-hc05',
    ...
    amazon_search: 'https://www.amazon.com/s?k=HC-05+bluetooth+module+arduino',
  },
  {
    id: 'rfid-rc522',
    ...
    amazon_search: 'https://www.amazon.com/s?k=RC522+RFID+reader+module+arduino',
  },
  {
    id: 'soil-moisture',
    ...
    amazon_search: 'https://www.amazon.com/s?k=soil+moisture+sensor+module+arduino',
  },
  {
    id: 'mpu6050',
    ...
    amazon_search: 'https://www.amazon.com/s?k=MPU-6050+gyroscope+accelerometer+arduino',
  },
  {
    id: 'neopixel-ws2812b',
    ...
    amazon_search: 'https://www.amazon.com/s?k=WS2812B+NeoPixel+LED+strip+arduino',
  },
  {
    id: 'joystick-module',
    ...
    amazon_search: 'https://www.amazon.com/s?k=joystick+module+arduino+analog',
  },
  {
    id: 'seven-segment',
    ...
    amazon_search: 'https://www.amazon.com/s?k=7+segment+display+arduino+MAX7219',
  },
  {
    id: 'keypad-4x4',
    ...
    amazon_search: 'https://www.amazon.com/s?k=4x4+matrix+keypad+membrane+arduino',
  },
  {
    id: 'sd-card-module',
    name: 'SD Card Module',
    ...
    amazon_search: 'https://www.amazon.com/s?k=micro+SD+card+module+arduino+SPI',
  },
  {
    id: 'ds3231-rtc',
    ...
    amazon_search: 'https://www.amazon.com/s?k=DS3231+real+time+clock+module+arduino',
  },
  {
    id: 'mq2-gas-sensor',
    ...
    amazon_search: 'https://www.amazon.com/s?k=MQ-2+gas+sensor+module+arduino',
  },
]
